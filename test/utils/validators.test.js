...
import { validateIntervalFormat, validateIntervalString, validateFileInput, isFilePath, validateCliArgs } from "../../src/utils/validators.js";
...
describe("Validator Utilities", () => {
	...
	describe("Edge Cases and Complex Scenarios", () => {
		...
		test("provides clear error context for arrays", () => {
			const data = [{ includes: ["10-100"] }, { includes: ["invalid-interval"] }, { includes: ["300-400"] }];
			const result = validateFileInput(data);
